    ...
    return(
        <form className="w-full flex flex-col items-center gap-y-3">
            <fieldset className="w-2/3 flex flex-col justify-center gap-y-3">
                <input type="text" className="px-2 py-1 text-black border outline-none rounded-md" placeholder="Username" required/>
                <input type="email" className="px-2 py-1 text-black border outline-none rounded-md" placeholder="Email" required/>
                <input type="password" className="px-2 py-1 text-black border outline-none rounded-md" placeholder="Password" required/>
                <input type="password" className="px-2 py-1 text-black border outline-none rounded-md" placeholder="Confirm Password" required/>
            </fieldset>
